        ...
        <div className="bg-white py-8 px-4 shadow sm:rounded-lg sm:px-10">
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-2">
              <span className={`text-sm font-medium ${step === 'admin' ? 'text-indigo-600' : 'text-gray-500'}`}>
                1. Admin Account
              </span>
              <span className={`text-sm font-medium ${step === 'plaid' ? 'text-indigo-600' : 'text-gray-500'}`}>
