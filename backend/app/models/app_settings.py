...
class AppSettings(Base):
    ...
    _database_password = Column("database_password", String(500), nullable=True)  # MySQL only - encrypted
    ...
    _plaid_production_secret = Column("plaid_production_secret", String(500), nullable=True)  # Encrypted
    ...
    def database_password(self, value: Optional[str]):
